...
<c:set var="pageTitle" value="친구 등록" />
...
<nav class="bg-gray-200 py-20">
    <div class="max-w-2xl mx-auto bg-white p-10 rounded-lg shadow-md">
        <h1 class="text-2xl mb-10">친구 등록</h1>
           <form action="doJoin" method="POST" onsubmit="join_submitForm(this); return false;">
            ...
            <input type="text" name="name" class="input input-bordered w-full p-2 mb-10 border rounded" placeholder="이름을 입력해주세요">

            <label for="schoool" class="block mb-2 text-base font-bold text-xl"><i class="bi bi-mortarboard mr-2 text-xl"></i>소속</label>
            <input class="input input-bordered w-20 mb-10 border rounded" type="text" name="school"/> 대학교 <input class="input input-bordered w-32 ml-2" type="text" name="depart"/> 과
            <!-- 설명 -->
            ...
            <input class="input input-bordered mb-10 w-24" type="text" name="phone1"/>-<input class="input input-bordered w-24" type="text" name="phone2"/>-<input class="input input-bordered w-24" type="text" name="phone3"/>
         <label for="email" class="block mb-2 text-base font-bold text-xl"><i class="bi bi-envelope-plus mr-2 text-xl"></i>이메일</label>
            <input type="text" name="email" class="input input-bordered w-full p-2 mb-4 border rounded" placeholder="이메일을 입력해주세요">
      <button class="btn w-full p-2 border rounded btn-success font-bold text-base mt-10 text-white">친구 등록</button> 
      </form>    
</div>
</nav>
